...
export default function ComandoVetor() {
  ...
  async function enviarTexto() {
    ...
    try {
      ...
      setMensagens((atual) => [...atual, { autor: "vetor", texto: data.respostaTexto }]);
    } catch (err) {
  ...
  async function enviarAudio(blob: Blob) {
    ...
    try {
      ...
      setMensagens((atual) => [...atual, { autor: "vetor", texto: data.respostaTexto, audioBase64: data.audioBase64 }]);
